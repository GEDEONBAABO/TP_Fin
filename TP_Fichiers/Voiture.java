...
class Voiture implements Serializable {
    ...
    public static Voiture fromFileFormat(String line) {
        ...
        return new Voiture(data[0], Integer.parseInt(data[1]), Integer.parseInt(data[2]), Integer.parseInt(data[3]),
                Integer.parseInt(data[4]));
    }

    public String description() {
        String desc = "J'ai une voiture de la marque " + this.marque + ", pneus " + this.nombrePneus;
        return desc;
    }
