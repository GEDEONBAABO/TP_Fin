class universite extends Institution {
    ...
    public universite(String nomInstitution, String typeInstitution, String paysInstitution, int anneeCreation, String systemeEnseignement, int nombreFacultes, String nomRecteur) {
